#FLM: Export L2L U2L U2U pairs

# Description:
# Export lists of kernign pairs, to be used in the Contextual Kerning tool
# 
...
#Get Upper to Lower
print "Searching for Upper to Lower Pairs"
target = uppercase
against = lowercase
output = open(dir+'/Kern Upper to Lower.txt', 'w')
...
#Get Upper to Upper
print "Searching for Upper to Upper Pairs"
target = uppercase
against = uppercase
output = open(dir+'/Kern Upper to Upper.txt', 'w')
